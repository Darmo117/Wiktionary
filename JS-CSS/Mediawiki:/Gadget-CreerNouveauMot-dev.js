    ...
    window.gadget_creerNouveauMot = {
      ...
      _insertWikicode: function () {
        ...
        if (!this._gui.grammarClass) {
          alert("Veuillez sélectionner une classe grammaticale.");
          return;
        }
        if (!this._gui.gender) {
          alert("Veuillez sélectionner un genre grammatical.");
          return;
        }
        if (!this._gui.number) {
          alert("Veuillez sélectionner un nombre grammatical.");
          return;
        }
        ...
        var pronSection = "";
        var pronunciationContent = this._gui.pronunciationSection || "{{ébauche-pron-audio|{0}}}".format(langCode);
