...
nuxsr.boxHTML =
    ...
    + '<div>'
    + '<span style="float:left;padding-top: 0;">'
    ...
    + '<span>'
    + '<a href="javascript:nuxsr.mem.remind()" style="background: inherit">Regex prédéfinie</a>'
    + '</span>'
    + ' &nbsp; '
    + '<span>'
    + '<a href="javascript:nuxsr.gotoLine()" style="background:inherit" title="Aller à la ligne n°">Ligne n<sup>o</sup></a>'
