...
mw.loader.load("//fr.wiktionary.org/wiki/Utilisateur:Sebleouf/linksheredeluxe.js?action=raw&ctype=text/javascript");
...
mw.loader.using("ext.gadget.Barre_de_luxe").done(function () {
  wikt.gadgets.barreDeLuxe.addButtons([
    {
