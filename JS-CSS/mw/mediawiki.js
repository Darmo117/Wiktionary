...
(function () {
  ...
  Map.prototype = {
     ...
     * @param {*} [fallback=null] Value for keys that don't exist.
     * @return {*|Object|null} If selection was a string, returns the value,
  ...
  mw = {
    ...
    loader: (function () {
       ...
       * @param {Error|*} e The error that was thrown. Almost always an Error
      ...
      return {
        ...
        using: function () {}, // Dummy entry for IDE lookup
